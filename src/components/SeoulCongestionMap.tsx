...
const DUMMY_CONGESTION: Record<string, string> = {
    종로구: '여유', 중구: '보통', 용산구: '보통', 성동구: '보통', 광진구: '붐빔',
    동대문구: '약간붐빔', 중랑구: '보통', 성북구: '보통', 강북구: '보통', 도봉구: '여유',
    노원구: '보통', 은평구: '보통', 서대문구: '보통', 마포구: '약간붐빔', 양천구: '여유',
    구로구: '약간 붐빔', 금천구: '약간붐빔', 영등포구: '보통', 동작구: '약간붐빔', 관악구: '붐빔',
    서초구: '붐빔', 강남구: '붐빔', 송파구: '약간붐빔', 강동구: '여유', 강서구:'보통',
};
        ...
        (async () => {
            ...
            if (!mapRef.current) {
                ...
                const onEachFeature = (feature: any, layer: any) => {
                    ...
                    const description = GU_DESCRIPTIONS[gu] || "상세 정보가 준비중입니다.";
                    ...
                    layer.on({
                        ...
                        click: (e: LeafletMouseEvent) => {
                            ...
                            // 1. 구별 설명 배열을 가져옴
                            const descriptionLines = GU_DESCRIPTIONS[gu] || ["상세 정보가 준비중입니다."];
